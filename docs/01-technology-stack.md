...
| 기술 | 용도 |
|------|------|
| **Protobuf** | gRPC 통신 스키마, 다언어 코드 생성 |
| **Avro** | Kafka 이벤트 스키마, 스키마 진화 지원 |
| **Thrift** | IDL 기반 RPC (Uber 등 사용) |

**현재 대안**: `common-lib`에 Java DTO 직접 공유 (단순, 다언어 확장 제약)

**판단 시점**: 카프카 도입 또는 다언어 서비스 추가 시
