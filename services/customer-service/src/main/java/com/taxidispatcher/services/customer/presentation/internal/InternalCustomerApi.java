 ...
 */
@Tag(name = "Internal Customer API", description = "서비스 간 통신용 내부 API")
...
public interface InternalCustomerApi {
    ...
    ResponseEntity<CommonResponse<CustomerInternalProfile>> findByAccountId(@PathVariable String accountId);
}
