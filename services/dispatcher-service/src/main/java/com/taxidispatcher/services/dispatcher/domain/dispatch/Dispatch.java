...
public class Dispatch {
    ...
    private Dispatch(DispatchId dispatchId, CustomerId customerId, Location departure, Location arrival) {
    ...
    // DB 복원용 생성자
    private Dispatch(
        DispatchId dispatchId, CustomerId customerId, DriverId driverId,
    ...
    public static Dispatch create(CustomerId customerId, Location departure, Location arrival) {
        return new Dispatch(DispatchId.generate(), customerId, departure, arrival);
    }

    public static Dispatch createWithId(DispatchId dispatchId, CustomerId customerId, Location departure, Location arrival) {
        return new Dispatch(dispatchId, customerId, departure, arrival);
    }
    ...
    public static Dispatch reconstitute(
        ...
        return new Dispatch(
            dispatchId, customerId, driverId, dispatchStatus, departure, arrival,
