...
public class DriverServiceClient {
    ...
    public Optional<DriverInternalProfile> findByAccountId(String accountId) {
        try {
            ...
            throw new RuntimeException("driver-service 호출 실패", e);

        } catch (Exception e) {
            log.error("driver-service 응답 파싱 실패: accountId={}", accountId, e);
            throw new RuntimeException("driver-service 응답 처리 실패", e);
        }
    }
}
